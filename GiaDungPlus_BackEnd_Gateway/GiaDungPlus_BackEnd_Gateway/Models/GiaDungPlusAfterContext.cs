...
namespace GiaDungPlus_BackEnd_Gateway.Models
{
    ...
    {
        public GiaDungPlusAfterContext(IConfiguration configuration)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DoGiaDung>(entity =>
            {
                entity.HasKey(e => e.MaSanPham)
                    .HasName("PK__DoGiaDun__FAC7442DAE3BDE6F");
            ...
            modelBuilder.Entity<HoaDonBan>(entity =>
            {
                entity.HasKey(e => e.MaHoaDonBan)
                    .HasName("PK__HoaDonBa__6A50CA8A9B7AC6CC");
            ...
            modelBuilder.Entity<HoaDonNhap>(entity =>
            {
                entity.HasKey(e => e.MaHoaDonNhap)
                    .HasName("PK__HoaDonNh__448838B545E9B895");
            ...
            modelBuilder.Entity<KhachHang>(entity =>
            {
                entity.HasKey(e => e.MaKhachHang)
                    .HasName("PK__KhachHan__88D2F0E5C3DA0DF8");
            ...
            modelBuilder.Entity<LoaiDoGiaDung>(entity =>
            {
                entity.HasKey(e => e.MaLoai)
                    .HasName("PK__LoaiDoGi__730A5759CC7C746C");
            ...
            modelBuilder.Entity<NhaCungCap>(entity =>
            {
                entity.HasKey(e => e.MaNhaCungCap)
                    .HasName("PK__NhaCungC__53DA9205DA041666");
            ...
            modelBuilder.Entity<NhanVien>(entity =>
            {
                entity.HasKey(e => e.MaNhanVien)
                    .HasName("PK__NhanVien__77B2CA47E571D96B");
            ...
            modelBuilder.Entity<Slide>(entity =>
            {
                entity.HasKey(e => e.MaAnh)
                    .HasName("PK__Slide__356240DFDD649C76");
            ...
            modelBuilder.Entity<TaiKhoan>(entity =>
            {
                entity.HasKey(e => e.MaTaiKhoan)
                    .HasName("PK__TaiKhoan__AD7C652947B2E63D");

                entity.ToTable("TaiKhoan");

                entity.HasIndex(e => e.TenTaiKhoan, "UQ__TaiKhoan__B106EAF8BB5E70B5")
                    .IsUnique();
